...
FmodAudioDevice::Open()
{
    ...
    if (!numdrivers)
    {
        n_error("No Sound-Device found\nFILE: %s\nLine:%d\n", __FILE__, __LINE__);
    }

    // this prevents from buggy audio-driver-crashs
    result = this->system->setHardwareChannels(0, 0, 0, 0);
    FMOD_CHECK_ERROR(result); 
    ...
    result = this->system->getDriverCaps(0, &caps, 0, 0, &speakermode);
    FMOD_CHECK_ERROR(result);
#if __PS3__
...
*/
const char*
FmodAudioDevice::FmodMemtypeToString(int type)
{
    switch(type)
    {
        Type2String(FMOD_MEMTYPE_OTHER);
        Type2String(FMOD_MEMTYPE_STRING);
        Type2String(FMOD_MEMTYPE_SYSTEM);
        Type2String(FMOD_MEMTYPE_PLUGINS);
        Type2String(FMOD_MEMTYPE_OUTPUT);
        Type2String(FMOD_MEMTYPE_CHANNEL);
        Type2String(FMOD_MEMTYPE_CHANNELGROUP);
        Type2String(FMOD_MEMTYPE_CODEC);
        Type2String(FMOD_MEMTYPE_FILE);
        Type2String(FMOD_MEMTYPE_SOUND);
        Type2String(FMOD_MEMTYPE_SOUND_SECONDARYRAM);
        Type2String(FMOD_MEMTYPE_SOUNDGROUP);
        Type2String(FMOD_MEMTYPE_STREAMBUFFER);
        Type2String(FMOD_MEMTYPE_DSPCONNECTION);
        Type2String(FMOD_MEMTYPE_DSP);
        Type2String(FMOD_MEMTYPE_DSPCODEC);
        Type2String(FMOD_MEMTYPE_PROFILE);
        Type2String(FMOD_MEMTYPE_RECORDBUFFER);
        Type2String(FMOD_MEMTYPE_REVERB);
        Type2String(FMOD_MEMTYPE_REVERBCHANNELPROPS);
        Type2String(FMOD_MEMTYPE_GEOMETRY);
        Type2String(FMOD_MEMTYPE_SYNCPOINT);
        Type2String(FMOD_MEMTYPE_EVENTSYSTEM);
        Type2String(FMOD_MEMTYPE_MUSICSYSTEM);
        Type2String(FMOD_MEMTYPE_FEV);
        Type2String(FMOD_MEMTYPE_MEMORYFSB);
        Type2String(FMOD_MEMTYPE_EVENTPROJECT);
        Type2String(FMOD_MEMTYPE_EVENTGROUPI);
        Type2String(FMOD_MEMTYPE_SOUNDBANKCLASS);
        Type2String(FMOD_MEMTYPE_SOUNDBANKLIST);
        Type2String(FMOD_MEMTYPE_STREAMINSTANCE);
        Type2String(FMOD_MEMTYPE_SOUNDDEFCLASS);
        Type2String(FMOD_MEMTYPE_SOUNDDEFDEFCLASS);
        Type2String(FMOD_MEMTYPE_SOUNDDEFPOOL);
        Type2String(FMOD_MEMTYPE_REVERBDEF);
        Type2String(FMOD_MEMTYPE_EVENTREVERB);
        Type2String(FMOD_MEMTYPE_USERPROPERTY);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCE);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCE_COMPLEX);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCE_SIMPLE);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCE_LAYER);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCE_SOUND);
        Type2String(FMOD_MEMTYPE_EVENTENVELOPE);
        Type2String(FMOD_MEMTYPE_EVENTENVELOPEDEF);
        Type2String(FMOD_MEMTYPE_EVENTPARAMETER);
        Type2String(FMOD_MEMTYPE_EVENTCATEGORY);
        Type2String(FMOD_MEMTYPE_EVENTENVELOPEPOINT);
        Type2String(FMOD_MEMTYPE_EVENTINSTANCEPOOL);
