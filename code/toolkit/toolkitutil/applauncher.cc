...
*/
void
AppLauncher::UpdateStdoutStream()
{
    if(this->stdoutCaptureStream.isvalid())
    {
...
*/
bool
AppLauncher::LaunchWithoutOutputCapturing(DWORD creationFlags, const String& cmdLine) const
{
    STARTUPINFO startupInfo = { sizeof(STARTUPINFO), 0 };
...
*/
bool
AppLauncher::LaunchWithOutputCapturing(DWORD creationFlags, const String& cmdLine) const
{ 
    HANDLE stdoutRead = 0;
...
*/
bool
AppLauncher::CreateStdoutCapturePipe(PHANDLE stdoutRead, PHANDLE stdoutWrite) const
{
...
*/
void
AppLauncher::CaptureOutput(HANDLE stdoutRead, HANDLE stderrRead, HANDLE childProcess) const
{
