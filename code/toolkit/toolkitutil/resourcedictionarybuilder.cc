...
ResourceDictionaryBuilder::ReadTextureData(Ptr<Stream>& stream, TextureInfo& format)
{
    ...
    case Platform::Xbox360:
        n_printf("ResourceDictionaryBuilder is not defined for XBOX360-Texture-formats!\n");
        break;

        // .tpl
    case Platform::Wii:
        n_printf("ResourceDictionaryBuilder is not defined for Wii-Texture-formats!\n");
        break;
