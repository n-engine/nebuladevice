...
*/
bool
AnimBuilderSaver::SaveNax3(const URI& uri, AnimBuilder& animBuilder, Platform::Code platform)
{
...
*/
void
AnimBuilderSaver::WriteHeader(const Ptr<Stream>& stream, AnimBuilder& animBuilder, const ByteOrder& byteOrder)
{
    // setup header
...
*/
void
AnimBuilderSaver::WriteClips(const Ptr<Stream>& stream, AnimBuilder& animBuilder, const ByteOrder& byteOrder)
{
...
*/
void
AnimBuilderSaver::WriteKeys(const Ptr<Stream>& stream, AnimBuilder& animBuilder, const ByteOrder& byteOrder)
{
    SizeT numClips = animBuilder.GetNumClips();
    IndexT clipIndex;
    for (clipIndex = 0; clipIndex < numClips; clipIndex++)
