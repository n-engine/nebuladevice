...
#define OS_OTHER (1)// use with Nebala3 and different platforms
...
#if OS_OTHER
#define sqlite3OsOpenReadWrite      sqlite3Nebula3OpenReadWrite
#define sqlite3OsOpenExclusive      sqlite3Nebula3OpenExclusive
#define sqlite3OsOpenReadOnly       sqlite3Nebula3OpenReadOnly
#define sqlite3OsDelete             sqlite3Nebula3Delete
#define sqlite3OsFileExists         sqlite3Nebula3FileExists
#define sqlite3OsFullPathname       sqlite3Nebula3FullPathname
#define sqlite3OsIsDirWritable      sqlite3Nebula3IsDirWritable
#define sqlite3OsSyncDirectory      sqlite3Nebula3SyncDirectory
#define sqlite3OsTempFileName       sqlite3Nebula3TempFileName
#define sqlite3OsRandomSeed         sqlite3Nebula3RandomSeed
#define sqlite3OsSleep              sqlite3Nebula3Sleep
#define sqlite3OsCurrentTime        sqlite3Nebula3CurrentTime
#define sqlite3OsEnterMutex         sqlite3Nebula3EnterMutex
#define sqlite3OsLeaveMutex         sqlite3Nebula3LeaveMutex
#define sqlite3OsInMutex            sqlite3Nebula3InMutex
#define sqlite3OsThreadSpecificData sqlite3Nebula3ThreadSpecificData
#define sqlite3OsMalloc             sqlite3GenericMalloc
#define sqlite3OsRealloc            sqlite3GenericRealloc
#define sqlite3OsFree               sqlite3GenericFree
#define sqlite3OsAllocationSize     sqlite3GenericAllocationSize
#define sqlite3OsDlopen             sqlite3Nebula3Dlopen
#define sqlite3OsDlsym              sqlite3Nebula3Dlsym
#define sqlite3OsDlclose            sqlite3Nebula3Dlclose
#endif
...
extern int sqlite3OsOpenReadWrite(const char*, OsFile**, int*);
extern int sqlite3OsOpenExclusive(const char*, OsFile**, int);
extern int sqlite3OsOpenReadOnly(const char*, OsFile**);
extern int sqlite3OsDelete(const char*);
extern int sqlite3OsFileExists(const char*);
extern char *sqlite3OsFullPathname(const char*);
extern int sqlite3OsIsDirWritable(char*);
extern int sqlite3OsSyncDirectory(const char*);
extern int sqlite3OsTempFileName(char*);
extern int sqlite3OsRandomSeed(char*);
extern int sqlite3OsSleep(int ms);
extern int sqlite3OsCurrentTime(double*);
extern void sqlite3OsEnterMutex(void);
extern void sqlite3OsLeaveMutex(void);
extern int sqlite3OsInMutex(int);
extern ThreadData *sqlite3OsThreadSpecificData(int);
extern void *sqlite3OsMalloc(int);
extern void *sqlite3OsRealloc(void *, int);
extern void sqlite3OsFree(void *);
extern int sqlite3OsAllocationSize(void *);
extern void *sqlite3OsDlopen(const char*);
extern void *sqlite3OsDlsym(void*, const char*);
extern int sqlite3OsDlclose(void*);
