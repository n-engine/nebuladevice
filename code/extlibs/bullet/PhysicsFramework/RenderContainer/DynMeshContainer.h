...
#ifndef __DYNMESH_CONTAINER_H__
#define __DYNMESH_CONTAINER_H__

#include "PhysicsFramework/RenderShape.h"
#include "PhysicsFramework/RenderContainer/RenderContainer.h"

///////////////////////////////////////////////////////////////////////////////
// DynMeshContainer class

class DynMeshContainer : public RenderContainer
{
private:
...
public:
	DynMeshContainer(RenderShape *shape);
	virtual ~DynMeshContainer();
	
	ContainerType getContainerType() {return ContainerTypeDynMesh;}
