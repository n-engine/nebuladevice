...
protected:
    ...
    FX::AnimEventRegistry::TimingEvent activeTimeEffect;
...
*/
inline void
TimeManager::ApplyGlobalAudioPitch() const
{
    // set audio stuff to
    if (Audio2::Audio2Server::Instance()->HasInstance())
    {
        Audio2::Audio2Server::Instance()->MasterCategorySetPitch((this->timeFactor - 1.0f) * 10.0f, Audio2::PitchUnitSemitones);
    }
}
