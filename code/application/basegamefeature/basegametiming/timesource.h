...
namespace Attr
{
    DeclareString(TimeSourceId, 'TIID', ReadWrite);
    DeclareFloat(TimeSourceTime, 'TIST', ReadWrite);
    DeclareFloat(TimeSourceFactor, 'TIFA', ReadWrite);
    DeclareInt(TimeSourceFrameId, 'TFID', ReadWrite);
};
