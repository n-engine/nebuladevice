...
namespace Attr
{
    ...
    DefineFloat4WithDefault(AnimPathOffset, 'ANPO', ReadWrite, Math::vector::nullvec());
};
...
PathAnimProperty::SetupDefaultAttributes()
{
    ...
    SetupAttr(Attr::AnimPath);
    SetupAttr(Attr::AnimRelative);
    SetupAttr(Attr::AnimLoop);
    SetupAttr(Attr::AnimPlaying);
    SetupAttr(Attr::AnimPathOffset);
