...
Float4Test::Run()
{
    STACK_CHECKPOINT("Float4Test::Run()");
    ...
    ALIGN16 const scalar fAlignedLoad[4] = { 1.0f, 2.0f, 3.0f, 4.0f };
    ALIGN16 scalar fAlignedStore[4];
	// check alignment
	...
	ALIGN16 const scalar fAlignedLoadBase[5] = { 0.0f, 1.0f, 2.0f, 3.0f, 4.0f };
	ALIGN16 scalar fAlignedStoreBase[5];
...
/*
	// load_ubyte4n_signed
	ALIGN16 const uchar ucArrAligned[8] = {0, 0, 128, 255, 0xEE, 0xDD, 0xBB, 0xAA };
	// check alignment
